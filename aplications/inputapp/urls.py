...
urlpatterns = [
    ...
    path('update_various_cost/<pk>/',views.MacroeconomicsIndicatorsUpdateView.as_view(), name='updateVariousCost'),
    path('delete_various_cost/<pk>/',views.MacroeconomicsIndicatorsDeleteView.as_view(), name='deleteVariousCost'),
